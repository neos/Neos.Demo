 ...
 */
class Version20121002121456 extends AbstractMigration
{
    /**
     * @param Schema $schema
     * @return void
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE typo3_phoenixdemotypo3org_domain_model_registration RENAME COLUMN flow3_persistence_identifier TO persistence_object_identifier");
    ...
    public function down(Schema $schema)
    {
        ...
        foreach ($foreignKeyHandlingSql['drop'] as $sql) {
            ...
            // rename identifier fields
        $this->addSql("ALTER TABLE typo3_phoenixdemotypo3org_domain_model_registration RENAME COLUMN persistence_object_identifier TO flow3_persistence_identifier");
